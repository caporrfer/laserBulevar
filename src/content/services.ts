...
export const services: Service[] = [
  {
    ...
    eyebrow: 'Mujeres y hombres',
    description: 'Consulta opciones de depilación láser en Láser Bulevar y encuentra un plan adaptado a las zonas que quieras tratar.',
    intro: 'Para rostro o cuerpo. Cuéntanos qué zonas te interesan y te orientaremos antes de concertar la primera sesión.',
    statement: 'Menos rutina. Más piel.',
    price: 15,
    unit: '/ sesión',
    image: laserImage,
  ...
  },
  {
    ...
    eyebrow: 'Tu piel, de cerca',
    description: 'Descubre el cuidado facial de Láser Bulevar y consulta las opciones disponibles según lo que buscas para tu piel.',
    intro: 'Un cuidado empieza por escuchar tu piel. Pregunta por las opciones actuales y recibe orientación antes de reservar.',
    statement: 'Luz para tu piel.',
    price: 45,
    unit: '/ sesión',
    image: facialImage,
  ...
  },
  {
    ...
    description: 'Conoce el área de cuidado corporal de Láser Bulevar y consulta qué opciones están disponibles para tu objetivo.',
    intro: 'Cuéntanos qué zona o aspecto te interesa. El centro te explicará las alternativas que ofrece actualmente.',
    statement: 'Tu cuerpo, a tu ritmo.',
    price: 35,
    unit: '/ sesión',
    image: corporalImage,
